...
const CalendarInput = () => {
  ...
  var 토1=[] ;
    ...
    //특정일자 첫날 요일
    const dayOfWeek = week[new Date(stringYear+"-"+stringMonth+"-"+"1").getDay()];
    console.log("요일",dayOfWeek);

    
    
    if(dayOfWeek===0){일=1;월=2;화=3;수=4;목=5;금=6;토=7}
    else if(dayOfWeek===1){월=1;화=2;수=3;목=4;금=5;토=6;일=7}
    else if(dayOfWeek===2){화=1;수=2;목=3;금=4;토=5;일=6;월=7}
    else if(dayOfWeek===3){수=1;목=2;금=3;토=4;일=5;월=6;화=7}
    else if(dayOfWeek===4){목=1;금=2;토=3;일=4;월=5;화=6;수=7}
    else if(dayOfWeek===5){금=1;토=2;일=3;월=4;화=5;수=6;목=7}
    else if(dayOfWeek===6){토=1;일=2;월=3;화=4;수=5;목=6;금=7}
...
useEffect(()=>{getDayOfWeek(2022,11)},[])
